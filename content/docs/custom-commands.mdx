...
description: Easily handle frequently asked questions, common queries, and repetitive tasks in a snap. Empower your server with quick access to custom commands.
permissions:
    bot:
        - View Channel
        - Send Messages
...
![custom command example](/docs-assets/custom-command.webp)
...
![sticky message example](/docs-assets/sticky-message.webp)
